...
<p align="center">
  <img src="https://raw.githubusercontent.com/Team-Omechu/.github/main/profile/assets/banner.png" alt="Omechu Banner" width="100%" />
</p>
-->

<h1 align="center">오메추 (Omechu)</h1>

<p align="center">
  <strong>오늘 뭐 먹지? 고민 끝, 추천 시작!</strong><br/>
  <sub>End the daily food dilemma — personalized recommendations, instantly.</sub>
</p>

<p align="center">
  사용자 맥락 기반 맞춤 메뉴/맛집 추천 서비스<br/>
  <em>Context-aware personalized menu & restaurant recommendation service</em>
</p>
...
<p align="center">
  <a href="https://github.com/Team-Omechu/Omechu-web"><img src="https://img.shields.io/badge/Frontend_Repo-181717?style=for-the-badge&logo=github&logoColor=white" alt="Frontend Repo"/></a>
  <a href="https://github.com/Team-Omechu/Omechu-server"><img src="https://img.shields.io/badge/Backend_Repo-181717?style=for-the-badge&logo=github&logoColor=white" alt="Backend Repo"/></a>
  <a href="https://github.com/Team-Omechu/Omechu-AI"><img src="https://img.shields.io/badge/AI_Repo-181717?style=for-the-badge&logo=github&logoColor=white" alt="AI Repo"/></a>
</p>
...
**오메추(Omechu)** 는 "오늘 뭐 먹지?"라는 매일의 고민을 해결하는 맞춤 메뉴 추천 서비스입니다.
사용자의 취향, 상황, 기분 등 맥락 정보를 기반으로 AI가 개인화된 메뉴와 맛집을 추천합니다.
5단계 온보딩으로 최소한의 입력만으로 바로 나만의 추천을 받아볼 수 있습니다.
...
| Feature | Description |
| :--- | :--- |
| **5단계 온보딩** | 최소 입력으로 맞춤 초기 추천 생성 |
| **컨텍스트 기반 탐색** | 태그·가격·정렬·검색 + 무한 스크롤 |
| **AI 메뉴 추천** | OpenAI 임베딩 기반 개인화 추천 |
| **맛집 상세** | 리뷰·평점·사진을 한눈에 |
| **찜 & 추천 목록** | 낙관적 업데이트로 즉시 반응 UX |
| **마이페이지** | 프로필 / 기본 상태 / FoodieLog |
| **메뉴배틀** | 두 메뉴 중 하나 선택하는 재미 요소 |
...
> **UMC 8기** 대학교 연합 IT 동아리 장기 프로젝트 &nbsp;·&nbsp; 오메추 팀
